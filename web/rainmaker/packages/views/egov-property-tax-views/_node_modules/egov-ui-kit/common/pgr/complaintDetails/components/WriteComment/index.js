...
var WriteComment = function WriteComment(_ref) {
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(_UI.Image, { style: imageStyles, className: "img-circle", size: "medium", source: userImage ? userImage : _download2.default }),
    _react2.default.createElement(_UI.TextArea, (0, _extends3.default)({}, fields.comment, {
    ...
    _react2.default.createElement(_UI.Icon, { className: "comment-send", action: "content", name: "send", style: iconStyle, color: "#00bcd1", onClick: function onClick() {
        return submitForm();
      } })
  );
};
