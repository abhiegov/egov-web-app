...
var StatusIcon = function StatusIcon(_ref) {
  ...
  switch (status) {
    case "open":
      return _react2.default.createElement(_UI.Icon, { action: "custom", name: "file-send", style: statusCommonIconStyle, color: "#f5a623" });
    case "assigned":
    case "reassignrequested":
    case "re-assign":
      return _react2.default.createElement(_UI.Icon, { action: "custom", name: "file-plus", style: statusCommonIconStyle, color: "#f5a623" });
    case "rejected":
      return _react2.default.createElement(_UI.Icon, { action: "content", name: "clear", style: statusRejectedIconStyle, color: "#FFFFFF" });
    case "resolved":
      return _react2.default.createElement(_UI.Icon, { action: "action", name: "done", style: statusResolvedIconStyle, color: "#FFFFFF" });
    case "closed":
      return _react2.default.createElement(_UI.Icon, { action: "action", name: "stars", style: statusResolvedIconStyle, color: "#FFFFFF" });
  }
};
    ...
    case "open":
      ...
      return _react2.default.createElement(
        ...
        role !== "citizen" && openStatusCount == 1 && (currentStatus === "open" || currentStatus === "assigned") && _react2.default.createElement(
          ...
          _react2.default.createElement(_UI.Icon, { action: "communication", name: "call", style: callIconStyle, color: "#22b25f" })
        ),
        ...
        _react2.default.createElement(_UI.Card, {
          ...
          textChildren: _react2.default.createElement(
            ...
            _react2.default.createElement(
              "div",
              { className: "rainmaker-displayInline" },
              _react2.default.createElement(_UI.Icon, { action: "action", name: "timeline", color: "#767676" }),
              " ",
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(_UI.TimeLine, {
                stepperProps: {
