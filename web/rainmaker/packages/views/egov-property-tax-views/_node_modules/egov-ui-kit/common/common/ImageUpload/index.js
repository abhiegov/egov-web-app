  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(_UI.Icon, { id: "image-upload", name: "add-a-photo", action: "image", style: { height: "20px", width: "20px" }, color: "#ffffff" })
      ),
  ...
  (0, _createClass3.default)(ImageUpload, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        loading && _react2.default.createElement(_UI.LoadingIndicator, null),
        !images.length ? _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(_UI.Icon, { id: "image-upload", action: "image", name: "add-a-photo", style: iconStyle, color: "#ffffff" })
          ),
          _react2.default.createElement(_translationNode2.default, { label: "CS_COMMON_UPLOAD_PHOTOS", labelStyle: labelStyle, fontSize: "12px" })
        ) : _react2.default.createElement(
          "div",
          ...
          images.map(function (image, index) {
            return _react2.default.createElement(
              ...
              _react2.default.createElement(_UI.Image, { source: image.imageUri, style: { height: "100px" } }),
              _react2.default.createElement(
                "div",
                { className: "image-remove", onClick: function onClick() {
                    return removeImage(index);
                  } },
                _react2.default.createElement(_UI.Icon, { id: "image-close-icon", action: "navigation", name: "close", color: "#ffffff", style: { width: "14px", height: "14px" } })
              )
            );
          }),
