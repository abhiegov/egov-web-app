...
var Footer = function (_Component) {
    ...
    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = Footer.__proto__ || Object.getPrototypeOf(Footer)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      return _navigationItems.navigationItems[role].map(function (item) {
        ...
        return (0, _extends3.default)({}, item, {
          label: _react2.default.createElement(_translationNode2.default, { className: "citizen-footer-text", fontSize: "12px", label: label, color: "#969696" }),
          icon: _react2.default.createElement(_UI.Icon, { action: action, name: name })
        });
      });
  ...
  (0, _createClass3.default)(Footer, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(_UI.BottomNavigation, { selectedIndex: bottomNavigationIndex, options: options, handleChange: function handleChange(index) {
