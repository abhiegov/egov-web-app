    ...
    sections: {
      one: {
        items: [{
          ...
          route: "/citizen",
          leftIcon: _react2.default.createElement(_UI.Icon, { action: "action", name: "home" }),
          style: {
            paddingBottom: "1px",
            paddingTop: "1px",
          ...
          leftIcon: _react2.default.createElement(_UI.Icon, { action: "social", name: "person" }),
          style: {
            paddingBottom: "3px",
            paddingTop: "3px"
          },
          ...
          leftIcon: _react2.default.createElement(_UI.Icon, { action: "action", name: "language" }),
          style: {
            borderBottom: "none"
          },
          id: "header-language"
      ...
      two: {
        items: [{
          ...
          leftIcon: _react2.default.createElement(_UI.Icon, { action: "communication", name: "call" }),
          style: {
            paddingBottom: "8px",
            paddingTop: "8px"
          },
          ...
          leftIcon: _react2.default.createElement(_UI.Icon, { action: "custom", name: "help-circle" }),
          style: {
            paddingBottom: "2px",
            paddingTop: "2px"
          },
          ...
          route: "/logout",
          leftIcon: _react2.default.createElement(_UI.Icon, { action: "action", name: "power-settings-new" }),
          style: {
            borderBottom: "none",
            borderLeft: "red"
          },
    ...
    sections: {
      one: {
        items: [{
          ...
          leftIcon: _react2.default.createElement(_UI.Icon, { action: "custom", name: "file-check" }),
