    ...
    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = Header.__proto__ || Object.getPrototypeOf(Header)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      var iconElementLeft = _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          { id: "icon-hamburger" },
          isHomeScreen ? _react2.default.createElement(_UI.Icon, { id: "icon-hamburger", action: "custom", name: "hamburger" }) : hideBackButton ? null : _react2.default.createElement(_UI.Icon, { id: "back-navigator", action: "navigation", name: "arrow-back" })
        )
      );
