...
var FeedbackPopup = function FeedbackPopup(_ref) {
  ...
  return _react2.default.createElement(
    "div",
    null,
    _react2.default.createElement(_UI.Dialog, {
      ...
      children: !submitted ? [_react2.default.createElement(
        ...
        _react2.default.createElement(_UI.Ratings, { className: "feedback-ratings", size: 40, count: 5, half: false })
        ...
        selected: selected,
        onCheck: onCheck
      }), _react2.default.createElement(_UI.TextArea, { key: "feedback-textarea", hintText: "Type your comments", underlineShow: true, hintStyle: { letterSpacing: "0.7px" } }), _react2.default.createElement(
        "div",
        { key: "feedback-submit-button", className: "feedback-popup-button-cont" },
        _react2.default.createElement(_UI.Button, { label: "SUBMIT", primary: true, fullWidth: true, onClick: onSubmit })
      )] : [_react2.default.createElement(
        "div",
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(_UI.Icon, { action: "navigation", name: "check" })
        )
